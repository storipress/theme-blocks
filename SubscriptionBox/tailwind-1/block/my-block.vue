<template>
  <Block id="subscribe" :block="block" class="py-16 md:py-32 md:px-16">
    <SubscribeForm class="subscribe-form">
      <template v-slot="{ result, message, clear }">
        <div kind="form-area">
          ...
          <div class="form-input-area relative mt-8">
...
<style lang="scss">
.form-btn-submit-text > .whitespace-pre-wrap {
  @apply p-0;
}
