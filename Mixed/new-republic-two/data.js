  ...
  articles: [
    {
      ...
      headline: 'https://picsum.photos/500/700',
    ...
    },
    {
      ...
      blurb: 'Fusce lacinia dictum nulla eu pulvinar. Etiam ut efficitur tellus, sed tristique lectus',
      headline: 'https://picsum.photos/1000/700',
      authors: [{ name: 'John Doe', url: '#' }],
      time: new Date(),
      url: '#',
    },
    {
      ...
      blurb: 'Fusce lacinia dictum nulla eu pulvinar. Etiam ut efficitur tellus, sed tristique lectus',
      headline: 'https://picsum.photos/500/900',
      authors: [{ name: 'John Doe', url: '#' }],
      time: new Date(),
      url: '#',
    },
    {
      title: 'Small Tidal Wave Forcast in Northern Regions',
      blurb: 'Fusce lacinia dictum nulla eu pulvinar. Etiam ut efficitur tellus, sed tristique lectus',
