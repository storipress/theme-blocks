...
export default {
  ...
  articles: {
    FASHION: [
      ...
      {
        title: 'Mi ipsum faucibus vitae aliquet nec ullamcorper sit',
    ...
    DESIGN: [
      {
        title: 'Viverra mauris in aliquam sem fringilla',
        blurb:
          'Arrive to Orcas Island via ferry and you’ll disembark feeling calm, curious and ready to embrace the slow drift into island time.',
        headline: 'https://picsum.photos/800/600',
        headlineCaption: 'This is caption',
    ...
    BEAUTY: [
      {
        title: 'Interdum velit laoreet id donec ultrices',
        blurb:
          'Arrive to Orcas Island via ferry and you’ll disembark feeling calm, curious and ready to embrace the slow drift into island time.',
        headline: 'https://picsum.photos/800/600',
        headlineCaption: 'This is caption',
    ...
    FINANCE: [
      {
        title: 'Lobortis elementum nibh tellus molestie',
        blurb:
          'Arrive to Orcas Island via ferry and you’ll disembark feeling calm, curious and ready to embrace the slow drift into island time.',
        headline: 'https://picsum.photos/800/600',
        headlineCaption: 'This is caption',
