...
export default {
  ...
  articles: [
    {
      title: 'Fusce lacinia dictum nulla eu pulvinar. Etiam ut efficitur tellus, sed tristique lectus',
  ...
  article: {
    title: 'Purple Gerbil Escapes From Florida Zoo Escapes From Florida',
    blurb: 'Fusce lacinia dictum nulla eu pulvinar. Etiam ut efficitur tellus, sed tristique lectus',
    headlineCaption: 'This is caption',
    headline: 'https://picsum.photos/400/600',
    url: 'https://example.com',
