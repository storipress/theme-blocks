<template>
  <Block :block="block" backgroundColor="eef0f2">
    <DeskSection v-slot="{ desk }" :order="0">
      <div class="mb-6 font-medium md:mb-10">
      ...
      <div class="lg:grid lg:grid-cols-4 lg:gap-x-9">
        <ArticleBlock v-for="i in 8" :key="i" v-slot="{ article }" class="mb-4 md:mb-8">
