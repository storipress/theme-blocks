<template>
  <ArticleBlock>
    <HeaderBlock class="md:px-20 md:pb-12 md:pt-20">
      <!--- hero --->
      <HeadlineWrapper class="hero-wrapper flex h-screen md:h-auto lg:min-h-[38rem]">
        <HeadlineImage
          class="absolute inset-0 w-full"
          :sizes="'(max-width: 768px) 200vw, (max-width: 1060px) 80vw, 90vw'"
        />
        <!--- hero text wrapper --->
        <div
          class="relative flex min-h-full w-full flex-col justify-between bg-black bg-opacity-40 px-6 text-center md:px-32"
        >
          <!--- Group 1 Start --->
          <div class="h-full flex-col md:h-auto">
            <!--- desk --->
            <ArticleInfo v-slot="{ article }">
              <LinkElement :href="article.deskUrl">
                <Desk
                  kind="hero-desk"
                  class="mb-4 block pt-7 lg:mb-4"
                  :fontSize="14"
                  fontFamily="Jost"
                  color="fff"
                  align="center"
            ...
            <!--- vert. line --->
            <div
              class="anim-line mx-auto inline-block h-[calc(100%-4rem)] border-l border-white md:hidden lg:block lg:h-20"
            />
          </div>
          <!--- Group 2 Start --->
          ...
          <!--- final vert. line --->
          <div class="anim-line mx-auto mb-7 inline-block h-full border-l border-white md:hidden lg:block lg:h-20" />
    ...
    <!--- content start --->
    <div class="mt-14 flex px-6 md:px-[16vw] lg:mt-28 lg:px-36">
      <div class="relative flex flex-auto flex-col lg:flex-row">
        <div class="post-head pr-8 md:hidden">
          <ArticleInfo v-slot="{ article }">
            <LinkElement :href="article.deskUrl">
              <Desk kind="meta-desk" class="meta-desk mb-6 inline-block md:pt-7 lg:mb-4" component="div" />
            </LinkElement>
          </ArticleInfo>
          <TitleElement
            class="lg:mb-12"
          ...
          />
          <ArticleInfo v-slot="{ socials }">
            <ul class="social-share-meta mb-14 block md:mt-5 lg:hidden">
              <li v-if="socials.facebook">
                <LinkElement target="_blank" rel="noopener" :href="socials.facebook">
                  <svg
                    fill="#7c7c7c"
        ...
        <div class="flex w-full flex-col flex-nowrap justify-center lg:flex-row">
          <div class="post-meta mb-14 md:pr-20 lg:mb-0">
            <AuthorList :fontSize="{ xs: 20, md: 13 }" class="mb-1 md:max-w-[15rem]">
              By&nbsp;
              <Authors />
            </AuthorList>
            ...
            <Date
              :fontSize="13"
              :bold="true"
              class="head-time absolute translate-x-4 rotate-90 transform md:static md:transform-none"
              format="d MMMM yyyy, p"
            />
            <ArticleInfo v-slot="{ socials }">
              <ul class="social-share-meta mt-5 hidden md:block">
                <li v-if="socials.facebook">
                  <LinkElement target="_blank" rel="noopener" :href="socials.facebook">
                    <svg
                      fill="#7c7c7c"
          ...
          <div class="post-body flex-auto lg:max-w-screen-sm">
            <Content>
