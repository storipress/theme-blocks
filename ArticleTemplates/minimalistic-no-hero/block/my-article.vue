<template>
  <ArticleBlock>
    <div class="mx-5 max-w-screen-sm pt-16 md:mx-auto md:pt-28">
        ...
        <div class="post-head flex flex-col justify-center">
          <ArticleInfo v-slot="{ article }">
            <LinkElement :href="article.deskUrl">
              <Desk component="div" class="inline-block" />
            </LinkElement>
          </ArticleInfo>
          <TitleElement
            kind="content-title"
          ...
          <Description
            ...
            color="000"
          />
          <AuthorList font-family="Jost" :fontSize="{ xs: 14, md: 15 }" :lineHeight="1.1" bold color="000">
            By&nbsp;
            <Authors />
          </AuthorList>
          <div class="flex flex-row pb-8 font-medium">
