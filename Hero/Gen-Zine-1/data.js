    ...
    TRAVEL: [
      {
        ...
        url: 'https://example.com',
        time: new Date(),
        authors: [{ name: 'Ariel Senior', url: 'https://example.com' }],
      },
    ],
    FOODIE: [
      {
        ...
        url: 'https://example.com',
        time: new Date(),
        authors: [{ name: 'Zoe Senior', url: 'https://example.com' }],
      },
    ],
    DESIGN: [
      {
        title: 'Arrive to Orcas Island via ferry and you’ll disembark feeling calm',
        ...
        url: 'https://example.com',
        time: new Date(),
        authors: [{ name: 'Jack Senior', url: 'https://example.com' }],
      },
    ],
    BEAUTY: [
      {
        title: 'Lorem embrace the slow drift into island time 1',
        blurb:
          'Arrive to Orcas Island via ferry and you’ll disembark feeling calm, curious and ready to embrace the slow drift into island time.',
        headline: 'https://picsum.photos/800/600',
        headlineCaption: 'This is caption',
        url: 'https://example.com',
        time: new Date(),
        authors: [{ name: 'Peter Senior', url: 'https://example.com' }],
      },
      {
        title: 'Lorem embrace the slow drift into island time 2',
        blurb:
          'Arrive to Orcas Island via ferry and you’ll disembark feeling calm, curious and ready to embrace the slow drift into island time.',
        headline: 'https://picsum.photos/800/600',
        headlineCaption: 'This is caption',
      ...
      {
        title: 'Lorem embrace the slow drift into island time 3',
        blurb:
          'Arrive to Orcas Island via ferry and you’ll disembark feeling calm, curious and ready to embrace the slow drift into island time.',
        headline: 'https://picsum.photos/800/600',
        headlineCaption: 'This is caption',
      ...
      {
        title: 'Lorem embrace the slow drift into island time 4',
        blurb:
          'Arrive to Orcas Island via ferry and you’ll disembark feeling calm, curious and ready to embrace the slow drift into island time.',
        headline: 'https://picsum.photos/800/600',
        headlineCaption: 'This is caption',
      ...
      {
        title: 'Lorem embrace the slow drift into island time 5',
        blurb:
          'Arrive to Orcas Island via ferry and you’ll disembark feeling calm, curious and ready to embrace the slow drift into island time.',
        headline: 'https://picsum.photos/800/600',
        headlineCaption: 'This is caption',
