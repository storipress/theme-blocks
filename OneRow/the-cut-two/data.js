  ...
  articles: [
    {
      ...
      blurb: 'Ripped Rock Likely To Win Village Show',
      headline: 'https://picsum.photos/900/500',
    ...
    },
    {
      ...
      blurb: 'Local man Set to Fly Out and Help With Hurricane Relief Effort',
      headline: 'https://picsum.photos/800/1000',
      url: 'https://example.com',
      time: new Date(),
      authors: [{ name: 'Evie-Mae Travis', url: 'https://example.com' }],
    },
  ],
  article: {
